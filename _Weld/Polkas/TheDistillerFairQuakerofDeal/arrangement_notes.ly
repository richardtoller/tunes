arrangement_notes = \markup \left-column {
  \line {" "}
  \line {" "}
  \line {\italic \huge "Arrangement notes"}
  \line {" "}
  \line {\large \smallCaps "The Distiller"}
  \line {\bold{Solo fiddle - Vicky} "plays intro and then the melody first time throough."}
